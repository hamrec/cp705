...
// Same, taking raw C strings -- callers writing a periodic diagnostic line
// into a local char[] buffer (the common case) resolve to this overload
// automatically and skip the heap allocation a std::string copy of the
// content would otherwise cost on every call.
